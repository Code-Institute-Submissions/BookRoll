This website was created for my mum's new bookkeeping and payroll outsourcing business called BookRoll. This site will act as an online business card and contact platform (once operational).
...
1. Navigate to my Github repository - <https://github.com/adamparker75/Lumley-U16s>
1. Click the green drop down that says clone or download.
...
4. To clone with HTTPS copy the URL in the box. <https://github.com/adamparker75/Lumley-U16s.git>
5. Open up your preferred IDE (Integrated Development Environment)
6. Change the directory to the location you want the clone to be made.
7. Type **git clone** and then paste the copied URL from step 3.
